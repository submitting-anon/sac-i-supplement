...
class LunarLander(gym.Env, EzPickle):
    ...
    def reset(self):
        ...
        print('W:',W)
        self.bomb = self.world.CreateStaticBody(shapes=edgeShape(vertices=[(0, 0), (W, 0)]))
        self.bomb.color1 = (0.0, 1.0, 0.0)
        self.bomb.color2 = (0.0, 1.0, 0.0)
    ...
    def render_withBomb(self,xc = -1, yc = 0, mytext="",mode='human'):
        from gym.envs.classic_control import rendering
        ...
        radius = 0.03
        R =  (VIEWPORT_W/SCALE/2)*radius
        XC =  (VIEWPORT_W/SCALE/2)*xc + (VIEWPORT_W/SCALE/2)
        YC =  (VIEWPORT_H/SCALE/2)*yc + self.helipad_y + LEG_DOWN/SCALE
        transform2 = rendering.Transform(translation=(XC, YC))  # Relative offset
        self.viewer.draw_circle(R, 10, True, color=(1,0,0)).add_attr(transform2) 
